Este é um projeto do teste para NeoApp, que consiste em criar uma aplicação de um e-commerce. Com as seguintes páginas: /produtos, /detalhe do produto e /carrinho.
